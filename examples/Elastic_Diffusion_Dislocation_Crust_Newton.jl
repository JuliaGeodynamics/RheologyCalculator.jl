...
function simulate_crustal_creep_newton(diffusion, dislocation, elastic, vars, env;
...
function setup_crustal_creep_newton()
    R = 8.314462618

    # Crust-like conditions: about 10-12 km depth and 400 degC.
...
function main()
    setup = setup_crustal_creep_newton()
