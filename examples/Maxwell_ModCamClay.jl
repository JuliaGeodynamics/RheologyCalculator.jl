...
using RheologyCalculator.RheologyModels: ModCamClay, compute_F, compute_Q
...
c, x, xnorm, vars, args, others = let
    ...
    plastic = ModCamClay(; M = 0.9, N = 0.5, r = 1.0e8, β = 0.1, Pt = -1.0e5, η_vp = 1.0e20)
...
function figure()
    ...
    GLMakie.save(joinpath(@__DIR__, "..", "docs", "assets", "ModCamClay.png"), fig)
