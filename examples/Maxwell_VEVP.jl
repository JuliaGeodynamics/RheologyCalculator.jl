...
c, x, xnorm, vars, args, others, yield_stress = let
    ...
    plastic = DruckerPrager(10.0e6, 5, 0)
...
# eqs = RheologyCalculator.RheologyModels.generate_equations(c)
# for eq in eqs
#     println(
#       "
#       self = $(eq.self)
...
let
    t_v, τ = stress_time(c, vars, x, xnorm, others; ntime = 1_500, dt = 1.0e8)
    darkmode = true
