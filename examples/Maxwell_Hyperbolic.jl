...
function figure()
    ...
    println("-------")
    t_v2, τ2, P2, F2, mode2_2 = stress_time(c, vars_2D(7.0e-14, 0*7.0e-15), x, xnorm, others; ntime = 80, dt = 1e7)
    println("-------")
    t_v3, τ3, P3, F3, mode2_3 = stress_time(c, vars_2D(7.0e-14, 7.0e-15), x, xnorm, others; ntime = 30, dt = 2e7)
    println("-------")
